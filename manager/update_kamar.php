      ...
      <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 text-primary" style="background-color: #4f2d01;">
        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-4 gap-3 text-white min-vh-100">
          ...
          <header class="mt-4 row">
            <div class="col">
              <h3 class="fw-light font-montserrat">Admin Workspace | Update Data Kamar</h3>
            </div>
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb font-montserrat">
              <li class="breadcrumb-item"><a href="show_kamar.php">Room</a></li>
              <li class="breadcrumb-item active" aria-current="page">Update Room Data <strong><?php echo $no ?></strong></li>
            </ol>
          </nav>
          <!--  -->
          ...
          include "../koneksi.php";
          $code = $_GET['no_kamar'];
          $query = mysqli_query($koneksi, "SELECT * FROM room WHERE room_no = '$code'");
          ...
          <main>
            <div class="mt-5 font-montserrat">
              ...
              <form action="update/update_process_kamar.php" method="post">
                <div class="row mb-3">
                  <label for="id_karyawan" class="col-sm-2 col-form-label">Room No</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="id_karyawan" name="room_no" value="<?php echo $row['room_no']; ?>" readonly>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="nama_karyawan" class="col-sm-2 col-form-label">Room Type</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="nama_karyawan" name="room_type" value="<?php echo $row['room_type']; ?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="employee_name" class="col-sm-2 col-form-label">Price <em>(Bnd)</em></label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="employee_id" name="price" value="<?php echo $row['price']; ?>">
                  </div>
                </div>
