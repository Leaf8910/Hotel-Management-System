      ...
      <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 text-primary" style="background-color: #4f2d01;">
        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-4 gap-3 text-white min-vh-100">
            ...
            <li class="nav-item">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-light text-small shadow" style="background-color: antiquewhite;">
                  ...
                  <li>
                    <a class="dropdown-item" href="show_detail.php">Payment Transaction</a>
                  </li>
                </ul>
              </div>
            </li>
          ...
          <header class="mt-4 row">
            <div class="col">
              <h3 class="fw-light font-montserrat">Admin Workspace | Add Employee Data</h3>
            </div>
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb font-montserrat">
              <li class="breadcrumb-item"><a href="show_karyawan.php">Employee</a></li>
          ...
          <main>
            <div class="mt-5 font-montserrat">
              ...
              <form action="add/add_process_karyawan.php" method="post">
                <div class="row mb-3">
                  <label for="id_karyawan" class="col-sm-2 col-form-label">Employee ID</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="id_karyawan" name="employee_data">
                  </div>
                </div>
                <div class="row mb-3">
