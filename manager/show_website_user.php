							...
							<li class="nav-item">
								<div class="dropdown">
									...
									<ul class="dropdown-menu dropdown-menu-light text-small shadow" style="background-color: antiquewhite;">
										<li>
											<a class="dropdown-item" href="show_payment.php">Payment</a>
										</li>
										<li>
											<hr class="dropdown-divider">
										</li>
										<li>
											<a class="dropdown-item" href="show_paymentdetail.php">Payment Details</a>
										</li>
									</ul>
								</div>
							</li>
							<li class="nav-item">
								<a href="show_customer.php" class="nav-link align-middle p-2 btn btn-dark btn-md">
									<i class="fs-4 bi bi-file-person"></i> 
									<span class="ms-1 d-none d-sm-inline">Customer</span>
								</a>
							</li>
							<li class="nav-item">
								<a href="show_employee.php" class="nav-link align-middle p-2 btn btn-dark btn-md">
									<i class="fs-4 bi bi-person-workspace"></i> 
									<span class="ms-1 d-none d-sm-inline">Employee</span>
								</a>
							</li>
							<li class="nav-item">
								<a href="show_room.php" class="nav-link align-middle p-2 btn btn-dark btn-md">
									<i class="fs-4 bi bi-houses"></i> 
									<span class="ms-1 d-none d-sm-inline">Room</span> 
								</a>
							</li>
							<li class="nav-item">
								<a href="show_website_user.php" class="nav-link align-middle p-2 btn btn-dark btn-md active" aria-current="page">
				...
				<div class="col py-3 ml-2">
					<div class="container">
						...
						<header class="mt-4 row">
							<div class="col">
								<h3 class="fw-light font-montserrat">Receptionist Workspace | Website User</h3>
							</div>
								...
								<table class="table table-striped text-center">
									...
									<tbody>
										...
										if (isset($_POST['choose'])) {
											...
											$input_user = mysqli_query($koneksi, "SELECT * FROM user WHERE $option LIKE '%$data_name%'");
										}
										else{
										...
										foreach ($input_user as $row) {
											echo "<tr>
															...
															<td>
																	<a href='delete/delete_user.php?email=$row[email]' class='btn btn-dark btn-md'>Delete</a>
															</td>
														</tr>";
											$no++;
										}
