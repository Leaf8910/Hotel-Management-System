...
<html lang="en">
      ...
      <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 text-primary" style="background-color: #4f2d01;">
        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-4 gap-3 text-white min-vh-100">
            ...
            <li class="nav-item">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-light text-small shadow" style="background-color: antiquewhite;">
                  <li>
                    <a class="dropdown-item" href="show_transaksi.php">Transaction</a>
                  </li>
                  <li>
                    <hr class="dropdown-divider">
                  </li>
                  <li>
                    <a class="dropdown-item" href="show_detail.php">Detail Transaction</a>
                  </li>
                </ul>
              </div>
            </li>
          ...
          <header class="mt-4 row">
            <div class="col">
              <h3 class="fw-light font-montserrat">Admin Workspace | Payment Data Update</h3>
            </div>
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb font-montserrat">
              ...
              <li class="breadcrumb-item active" aria-current="page">Update Payment Data <strong><?php echo $no ?></strong> </li>
            </ol>
          </nav>
          <!--  -->
          ...
          $query = mysqli_query($koneksi, "SELECT * FROM payment WHERE payment_no = '$code'");
                ...
                <form class="row g-3" action="update/update_process_transaksi.php" method="post">
                  <div class="col-12">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" name="payment_no" id="payment_no" placeholder="name@example.com" value="<?php echo $row_data['payment_no']; ?>" readonly>
                      <label for="no_transaksi">Payment No.</label>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-floating">
                      <select class="form-select" name="customer_id" id="customer_id" aria-label="Floating label select example">
                        <?php
                        echo "<option value=" .$row_data['customer_id']. ">" .$row_data['customer_id']. "</option>";
                        echo "<option>--</option>";
                        include "../koneksi.php";
                        $customer_id = mysqli_query($koneksi, "SELECT * FROM customer");
                  ...
                  <div class="col-md-6">
                    <div class="form-floating">
                      <select class="form-select" name="employee_id" id="employee_id" aria-label="Floating label select example">
                        <?php
                        echo "<option value=" .$row_data['employee_id']. ">" .$row_data['employee_id']. "</option>";
                        echo "<option>--</option>";
                        include "../koneksi.php";
                        $employee_id = mysqli_query($koneksi, "SELECT * FROM employee");
                  ...
                  <div class="col-12">
                    <div id="row">
                      <div class="input-group mb-3">
                        <div class="form-floating">
                          <select class="form-select" name="room_data[]" id="room" aria-label="Floating label select example">
                            <option selected>---</option>
                            <?php
                            include "../koneksi.php";
                            $no_kamar = mysqli_query($koneksi, "SELECT * FROM room");
                            foreach ($room_no as $row) {
                              echo "<option value=" . $row['room_no'] . ">" . $row['room_no'] . " : " . $row['room_type'] . ", Bnd. " . $row['price'] . "</option>";
                            }
                  ...
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      <input type="date" class="form-control" name="date_checkin" id="payment_no" placeholder="name@example.com" value="<?php echo $row_data['date_checkin']; ?>">
                      <label for="payment_no">Date CheckIn</label>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      <input type="date" class="form-control" name="dtae_checkout" id="payment_no" placeholder="name@example.com" value="<?php echo $row_data['date_checkout']; ?>">
                      <label for="payment_no">Date CheckOut</label>
                    </div>
                  </div>
                  <div class="col-12">
  ...
  <script>
    $("#rowAdder").click(function(){
      ...
      '<?php $no_kamar = mysqli_query($koneksi, "SELECT * FROM room"); ?>' +
