				...
				<div class="col py-3 ml-2">
					<div class="container">
						...
						<header class="mt-4 row">
							<div class="col">
								<h3 class="fw-light font-montserrat">Receptionist Workspace | Room</h3>
							</div>
						...
						<main class="mt-3">
							<!-- add data -->
							<section>
								<a href="add_room.php" class="btn btn-dark btn-md font-montserrat">Add Data</a>
							</section>
							<!--  -->
								...
								<table class="table table-striped text-center">
									<thead>
										<tr>
											...
											<th scope="col" class="fst-italic fw-normal">Price</th>
									...
									<tbody>
										...
										if (isset($_POST['search'])) {
											...
											$input_room = mysqli_query($koneksi, "SELECT * FROM room WHERE $option LIKE '%$data_name%'");
										}
										else{
											$input_room = mysqli_query($koneksi, "SELECT * FROM room");
										}
										?>
										<!--  -->
										...
										foreach ($input_room as $row) {
											echo "<tr>
															...
															<td>" . $row['price'] . "</td>
															<td>
																	<a href='update_kamar.php?room_no=$row[room_no]' class='btn btn-dark btn-md'>Update</a>
															</td>
															<td>
																	<a href='delete/delete_kamar.php?room_no=$row[room_no]' class='btn btn-dark btn-md'>Delete</a>
															</td>
														</tr>";
											$no++;
										}
