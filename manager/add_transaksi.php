...
<html lang="en">
      ...
      <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 text-primary" style="background-color: #4f2d01;">
        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-4 gap-3 text-white min-vh-100">
          ...
          <header class="mt-4 row">
            <div class="col">
              <h3 class="fw-light font-montserrat">Admin Workspace | Add Transaction Data</h3>
            </div>
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb font-montserrat">
              ...
              <li class="breadcrumb-item active" aria-current="page">Add Payment Data</li>
            </ol>
          </nav>
          <!--  -->
                ...
                <form class="row g-3" action="add/add_process_transaksi.php" method="post">
                  <div class="col-12">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" name="payment_number" id="payment_number" placeholder="name@example.com">
                      ...
                      <div class="input-group mb-3">
                        <div class="form-floating">
                          <select class="form-select" name="room_data[]" id="room" aria-label="Floating label select example">
                            ...
                            include "../koneksi.php";
                            $room_no = mysqli_query($koneksi, "SELECT * FROM room");
                  ...
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      <input type="date" class="form-control" name="dtae_checkin" id="payment_no" placeholder="name@example.com">
                      <label for="payment_no">Date CheckIn</label>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      <input type="date" class="form-control" name="date_checkout" id="payemnt_no" placeholder="name@example.com">
  ...
  <script>
    $("#rowAdder").click(function(){
      ...
      '<?php $room_no = mysqli_query($koneksi, "SELECT * FROM room"); ?>' +
