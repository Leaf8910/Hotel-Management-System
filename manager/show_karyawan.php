				...
				<div class="col py-3 ml-2">
					<div class="container">
						...
						<header class="mt-4 row">
							<div class="col">
								<h3 class="fw-light font-montserrat">Receptionist Workspace | Employee</h3>
							</div>
											...
											<div class="d-flex align-items-center flex-wrap gap-2 font-montserrat">
												...
												<div class="">
													<select name="choose" id="search" class="btn btn-dark btn-md">
														...
														<option value="employee_name">Full Name</option>
												...
												<div class="">
													<input type="submit" name="search" value="Search based" class="btn btn-dark btn-md">	
												</div>
												<div class="">
								...
								<table class="table table-striped text-center">
									...
									<tbody>
										...
										if (isset($_POST['search'])) {
											...
											$input_employee = mysqli_query($koneksi, "SELECT * FROM employee WHERE $option LIKE '%$data_name%'");
										}
										else{
											$input_employee = mysqli_query($koneksi, "SELECT * FROM employee");
										}
										?>
										<!--  -->
										...
										foreach ($input_employee as $row) {
											echo "<tr>
															...
															<td>" . $row['gender'] . "</td>
															<td>
																	<a href='update_karyawan.php?employee_id=$row[employee_id]' class='btn btn-dark btn-md'>Update</a>
															</td>
															<td>
																	<a href='delete/delete_karyawan.php?employee_id=$row[employee_id]' class='btn btn-dark btn-md'>Delete</a>
															</td>
														</tr>";
											$no++;
										}
