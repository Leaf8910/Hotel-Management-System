				...
				<div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 text-primary" style="background-color: #4f2d01;">
					<div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-4 gap-3 text-white min-vh-100">
						...
						<ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start font-montserrat" id="menu">
							...
							<li class="nav-item">
								<div class="dropdown">
									...
									<ul class="dropdown-menu dropdown-menu-light text-small shadow" style="background-color: antiquewhite;">
										...
										<li>
											<a class="dropdown-item" href="show_detail.php">Transaction Detail</a>
										</li>
									</ul>
								</div>
							</li>
							...
							<li class="nav-item">
								<a href="show_kamar.php" class="nav-link align-middle p-2 btn btn-dark btn-md active" aria-current="page">
				...
				<div class="col py-3 ml-2">
					<div class="container">
						...
						<header class="mt-4 row">
							<div class="col">
								<h3 class="fw-light font-montserrat">Admin Workspace | Room</h3>
							</div>
							...
							<section class="mt-4">
										<form action="" method="post">
											<div class="d-flex align-items-center flex-wrap gap-2 font-montserrat">
												...
												<div class="">
													<input type="text" name="textsearch" class="form-control-sm">
												</div>
												<div class="">
													<input type="submit" name="find" value="Find" class="btn btn-dark btn-md">	
												</div>
												<div class="">
								...
								<table class="table table-striped text-center">
									<thead>
										<tr>
											...
											<th scope="col" class="fst-italic fw-normal">Room No.</th>
											<th scope="col" class="fst-italic fw-normal">Room Type</th>
											<th scope="col" class="fst-italic fw-normal">Price (Bnd.)</th>
									...
									<tbody>
										...
										if (isset($_POST['find'])) {
											$option = $_POST['choose'];
											$data_name= $_POST['textsearch'];
											$room_input = mysqli_query($koneksi, "SELECT * FROM room WHERE $option LIKE '%$data_name%'");
										}
										else{
											$room_input = mysqli_query($koneksi, "SELECT * FROM room");
										}
										?>
										<!--  -->
										...
										foreach ($room_input as $row) {
											echo "<tr>
															...
															<td>" . $row['price'] . "</td>
															<td>
																	<a href='update_kamar.php?no_kamar=$row[room_no]' class='btn btn-dark btn-md'>Update</a>
															</td>
															<td>
																	<a href='delete/delete_kamar.php?no_kamar=$row[room_no]' class='btn btn-dark btn-md'>Delete</a>
															</td>
														</tr>";
											$no++;
										}
