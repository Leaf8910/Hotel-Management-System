      ...
      <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 text-primary" style="background-color: #4f2d01;">
        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-4 gap-3 text-white min-vh-100">
          ...
          <header class="mt-4 row">
            <div class="col">
              <h3 class="fw-light font-montserrat">Receptionist Workspace | Payment Details</h3>
            </div>
											...
											<div class="d-flex align-items-center flex-wrap gap-2 font-montserrat">
												...
												<div class="">
													<select name="choose" id="search" class="btn btn-dark btn-md">
														<option value="">------</option>
														<option value="payment_detail_id">Payment ID Detail</option>
								...
								<table class="table table-striped text-center">
									<thead>
										<tr>
											...
											<th scope="col" class="fst-italic fw-normal">Payment Details ID</th>
									...
									<tbody>
										...
										if (isset($_POST['search'])) {
											...
											$input_detail = mysqli_query($koneksi, "SELECT * FROM payment_detail WHERE $option LIKE '%$data_name%'");
										}
										else{
											$input_detail = mysqli_query($koneksi, "SELECT * FROM payment_detail");
										}
										?>
										<!--  -->
										...
										foreach ($input_detail as $row) {
											echo "<tr>
															...
															<td>" . $row['room_no'] . "</td>
															<td>
																	<a href='update_detail.php?payment_detail_id=$row[payment_detail_id]' class='btn btn-dark btn-md'>Update</a>
															</td>
															<td>
																	<a href='delete/delete_detail.php?payment_detail_id=$row[payment_detail_id]' class='btn btn-dark btn-md'>Delete</a>
															</td>
														</tr>";
											$no++;
										}
