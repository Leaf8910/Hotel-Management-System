      ...
      <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 text-primary" style="background-color: #4f2d01;">
        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-4 gap-3 text-white min-vh-100">
          ...
          <header class="mt-4 row">
            <div class="col">
              <h3 class="fw-light font-montserrat">Admin Workspace | Add Customer Dat</h3>
            </div>
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb font-montserrat">
              ...
              <li class="breadcrumb-item active" aria-current="page">Add Customer Data</li>
            </ol>
          </nav>
          <!--  -->
                ...
                <form class="row g-3" action="add/add_process_pengunjung.php" method="post">
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="id" name="customer_id" placeholder="name@example.com">
                      <label for="id">Customer ID</label>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="nama" name="customer_name" placeholder="name@example.com">
                      <label for="nama">Customer Name</label>
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="form-floating">
                      <textarea class="form-control" placeholder="Leave a comment here" id="address" name="address"></textarea>
                      <label for="alamat">Address</label>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="id" name="phonenumber" placeholder="name@example.com">
                      <label for="id">Telephone Number</label>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="name" name="ic_no" placeholder="name@example.com">
