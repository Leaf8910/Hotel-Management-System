				...
				<div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 text-primary" style="background-color: #4f2d01;">
					<div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-4 gap-3 text-white min-vh-100">
						...
						<ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start font-montserrat" id="menu">
							...
							<li class="nav-item">
								<a href="show_pengunjung.php" class="nav-link align-middle p-2 btn btn-dark btn-md active" aria-current="page">
				...
				<div class="col py-3 ml-2">
					<div class="container">
						...
						<header class="mt-4 row">
							<div class="col">
								<h3 class="fw-light font-montserrat">Receptionist Workspace | Customer</h3>
							</div>
											...
											<div class="d-flex align-items-center flex-wrap gap-2 font-montserrat">
												...
												<div class="">
													<select name="choose" id="search" class="btn btn-dark btn-md">
														...
														<option value="customer_id">Full Name</option>
														<option value="address">Address</option>
														<option value="gender">Gender</option>
														<option value="phonenumber">Phone Number</option>
														<option value="ic_no">IC No</option>
													</select>
												</div>
												<div class="">
								...
								<table class="table table-striped text-center">
									<thead>
										<tr>
											...
											<th scope="col" class="fst-italic fw-normal">Full Name</th>
											<th scope="col" class="fst-italic fw-normal">Address</th>
											<th scope="col" class="fst-italic fw-normal">Gender</th>
											<th scope="col" class="fst-italic fw-normal">Phone Number</th>
											<th scope="col" class="fst-italic fw-normal">IC No</th>
									...
									<tbody>
										...
										if (isset($_POST['search'])) {
											...
											$input_customer = mysqli_query($koneksi, "SELECT * FROM customer WHERE $option LIKE '%$data_name%'");
										}
										else{
											$input_customer = mysqli_query($koneksi, "SELECT * FROM customer");
										}
										?>
										<!--  -->
										...
										foreach ($input_customer as $row) {
											echo "<tr>
															...
															<td>" . $row['ic_no'] . "</td>
															<td>
																	<a href='update_pengunjung.php?customer_id=$row[customer_id]' class='btn btn-dark btn-md'>Update</a>
															</td>
															<td>
																	<a href='delete/delete_pengunjung.php?customer_id=$row[customer_id]' class='btn btn-dark btn-md'>Delete</a>
															</td>
														</tr>";
											$no++;
										}
